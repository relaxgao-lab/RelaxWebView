package com.relaxgao.relaxgao.webviewprocess.webchromeclient;
...
public class RelaxgaoWebChromeClient extends WebChromeClient {
    private WebViewCallBack mWebViewCallBack;
    private static final String TAG = "WebChromeClient";

    public RelaxgaoWebChromeClient(WebViewCallBack webViewCallBack) {
